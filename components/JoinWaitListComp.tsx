      ...
      <div className="container" data-scroll-section>
        ...
        <div className={styles.joinwait_main}>
          <div className={styles.joinwait_texts}>
            ...
            <p>
              Blockplot is a permissioned ecosystem for tokenized assets. A
              protocol built for the protection of issuers, investors and other
              participants of the private market, with in-built on-chain
              compliance
            </p>
          </div>
          <div className={styles.joinwait_form}>
            <div className={styles.joinwait_form_header}>
              <h2>Get access</h2>
              <h5>Be a member of our community of real estate investors</h5>
            </div>
