            ...
            <div className="container">
                <div className={styles.community_div}>
                    <div className={styles.community_header}>
                        <h3>Community</h3>
                        <p>
                            Join our vast community across different social
                            media platform
                        </p>
                    </div>
                    <div className={styles.community_socialhandles}>
                        <div className={styles.socialmedia_handles}>
                            ...
                            <h3 className={styles.socialmedia_body}>
                                Join our twitter community and stay updated
                                always
                            </h3>
                        </div>
                        <div className={styles.socialmedia_handles}>
                            ...
                            <h3 className={styles.socialmedia_body}>
                                Join our reddit community and stay updated
                                always
                            </h3>
                        </div>
                        <div className={styles.socialmedia_handles}>
                        ...
                        <div className={styles.socialmedia_handles}>
                            ...
                            <h3 className={styles.socialmedia_body}>
                                Join our instagram community and stay updated
                                always
                            </h3>
                        </div>
                        <div className={styles.socialmedia_handles}>
                            ...
                            <h3 className={styles.socialmedia_body}>
                                Join our medium community and stay updated
                                always
                            </h3>
                        </div>
                        <div className={styles.socialmedia_handles}>
                            ...
                            <h3 className={styles.socialmedia_body}>
                                Join our telegram community and stay updated
                                always
                            </h3>
                        </div>
                        <div className={styles.socialmedia_handles}>
                            ...
                            <h3 className={styles.socialmedia_body}>
                                Join our youtube community and stay updated
                                always
                            </h3>
                        </div>
                    </div>
